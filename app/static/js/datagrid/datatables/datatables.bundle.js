...
$.extend(true, $.fn.dataTable.defaults, {
  ...
  language: {
    ...
    search:
      '<div class="input-group-text d-inline-flex width-3 align-items-center justify-content-center border-bottom-right-radius-0 border-top-right-radius-0 border-right-0"><i class="fal fa-search"></i></div>',
    /* add search filter */
  ...
  $.extend(altEditor.prototype, {
    ...
    _openEditModal: function () {
      ...
      for (var j in columnDefs) {
        ...
        if (columnDefs[j].type.indexOf("hidden") >= 0) {
          ...
          if (
            columnDefs[j].type.indexOf("text") >= 0 ||
    ...
    _errorCallback: function (response, status, more) {
      ...
      var message =
        ...
        "<strong>Error!</strong> " +
        (error.status == null ? "" : "Response code: " + error.status) +
        " " +
        errstr +
        "</div>";
      ...
      $('form[name="altEditor-form"] *')
        ...
        .each(function (i) {
          ...
          // now check if its should be unique
            ...
            var colData = dt
              .column("th:contains('" + $(this).attr("name") + "')")
              .data();
