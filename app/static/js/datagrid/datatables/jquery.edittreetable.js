...
(function ($) {
  $.fn.bstreetable = function (options) {
    ...
    var dom_addFirstLevel = $("<div class='tt-operation m-b-sm'></div>").append(
      $(
        "<button class='btn btn-primary btn-sm j-addClass'><i class='fa fa-level-down'></i>&nbsp;Add A Root Node</button>"
      )
    );
    ...
    function generateColumn(row, extfield) {
      ...
      switch (extfield.type) {
        case "input":
          generatedCol = $("<input type='text' class='form-control input-sm'/>")
